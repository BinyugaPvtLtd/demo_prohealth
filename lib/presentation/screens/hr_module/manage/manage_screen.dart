                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                        Color(0xFF52A889), // Background color of the card
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                          Color(0xffB1D6F4), // Background color of the card
                          borderRadius: BorderRadius.only(
                              ...
                              children: [
                                ...
                                Padding(
                                    ...
                                    child: IconButton(
                                      ...
                                      icon: Row(
                                        children: [
                                          Icon(Icons.edit,color: Color(0xFF1696C8),),
                                          SizedBox(width: MediaQuery.of(context).size.width/150,), // Adjust the space between the icon and text as needed
                                          Text(
                                            'Edit',
                                            style: TextStyle(
                                              fontFamily: 'FiraSans',
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Image.asset('images/powered_logo.png',height: 23,width: 30,),
                    Text(
                      'Powered by',
                      style: TextStyle(
                          fontFamily: 'FiraSans',
...
class EditableButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton.icon(
      onPressed: onPressed,
      icon: Icon(icon,color: Color(0xFF1696C8),),
